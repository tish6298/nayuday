!function(e, t) {
    ...
    return function(e) {
        ...
        // Validate target
        if ("object" != typeof a.target && "string" != typeof a.target)
        ...
        if ("object" == typeof a.target && (null === a.target || !a.target instanceof HTMLCanvasElement) ||
            "string" == typeof a.target && (null === document.getElementById(a.target) || !document.getElementById(a.target) instanceof HTMLCanvasElement))
        ...
        function l(e) {
            if (e) {
                o.fillStyle = o.strokeStyle = "rgba(" + e.color + ", " + (3 < e.radius ? .8 : .4) + ")";
                o.beginPath();
                switch (e.prop) {
                    case "circle":
                        o.moveTo(e.x, e.y);
